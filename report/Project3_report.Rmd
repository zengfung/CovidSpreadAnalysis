...
x = covid_model.d7[,c("lag_stay_home", "lag_stay_home_diff_07", "lag_delta_infec_07ma")]
x = as.matrix(x)
x = as.numeric(x)
x = matrix(x, ncol = 3)
H = x %*% solve(t(x) %*% x) %*% t(x)
