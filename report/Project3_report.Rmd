...
(2) Test for fixed effects vs random effects 
```{r}
...
For (1), a test for potential outliers is not necessary since our predictor variables are either categorical or have the same range as the response variable.
